...
/*********************************************************************************************************
** Function name:           readMsg0
** Descriptions:            read message
** input parameters:        NONE
** Output parameters:       NONE
** Returned value:          if success
*********************************************************************************************************/
INT8U MCP_CAN::readMsg0()
{
    INT8U stat, res;
...
/*********************************************************************************************************
** Function name:           readMsg1
** Descriptions:            read message
** input parameters:        NONE
** Output parameters:       NONE
** Returned value:          if success
*********************************************************************************************************/
INT8U MCP_CAN::readMsg1()
{
    INT8U stat, res;
...
/*********************************************************************************************************
** Function name:           readMsgBuf0
** Descriptions:            read message buf
** input parameters:        len:    data length
** Output parameters:       buf:    data buf
** Returned value:          if success
*********************************************************************************************************/
INT8U MCP_CAN::readMsgBuf0(INT8U *len, INT8U buf[])
{
    readMsg0();
    *len = m_nDlc;
    for(int i = 0; i<m_nDlc; i++)
...
/*********************************************************************************************************
** Function name:           readMsgBuf1
** Descriptions:            read message buf
** input parameters:        len:    data length
** Output parameters:       buf:    data buf
** Returned value:          if success
*********************************************************************************************************/
INT8U MCP_CAN::readMsgBuf1(INT8U *len, INT8U buf[])
{
    readMsg1();
    *len = m_nDlc;
    for(int i = 0; i<m_nDlc; i++)
...
/*********************************************************************************************************
** Function name:           clearRX0Status
** Descriptions:            clears the receive status bits for the RX0 register.
** input parameters:        NONE
** Output parameters:       NONE
** Returned value:          NONE
*********************************************************************************************************/
void MCP_CAN::clearRX0Status() {
	digitalWrite(SS, LOW);
	SPI.transfer(BIT_MODIFY);  //instruction
	SPI.transfer(CANINTF); //target
	SPI.transfer(0x01);  // Mask
	SPI.transfer(0x00);  // Data
	digitalWrite(SS, HIGH);
}
/*********************************************************************************************************
** Function name:           clearRX1Status
** Descriptions:            clears the receive status bits for the RX1 register.
** input parameters:        NONE
** Output parameters:       NONE
** Returned value:          NONE
*********************************************************************************************************/
void MCP_CAN::clearRX1Status() {
	digitalWrite(SS, LOW);
	SPI.transfer(BIT_MODIFY);  //instruction
	SPI.transfer(CANINTF); //target
	SPI.transfer(0x02);  //  Mask
	SPI.transfer(0x00);  //  Data
	digitalWrite(SS, HIGH);
}
...
NOT TESTED DO NOT USE.
 Function name:           waitForNewMessage
** Descriptions:            This method to checks to see if any received packets are different from the last received packet.  Not normally useful.
** input parameters:        NONE
** Output parameters:       NONE
** Returned value:          NONE
*********************************************************************************************************/
/***************
void MCP_CAN::waitForNewMessage(INT8U len, INT8U *newbuf, INT8U *oldbuf){
	int identical = 0, i = 0;
    self.readMsgBuf(&len, newbuf);    // read data,  len: data length, buf: data buf
	 //**  Loop through until a different packet is detected.  **
	for(identical=0;identical==0;)
    {
		//**  Compare against past reading.  **
		for(i=0;i<len;i++)
		{
