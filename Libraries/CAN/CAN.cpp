...
/**  Added by Matthew ENgland code taken from the model train library.  **/

void CANClass::set_filters_accept_all()
{
...
void CANClass::setReceiveBuffers()
{
	setRegister(RXB0CTRL,0x64);
	setRegister(RXB1CTRL,0x64);
	/**  Enable the CANINTE interrupts.  **/
	setRegister(CANINTE,0xFF);
}