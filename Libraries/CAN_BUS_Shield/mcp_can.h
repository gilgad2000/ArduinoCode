...
*/    
	...
	/***  Added by Matthew England.  **/
	INT8U readMsg0();                                                /* read message                 */
	INT8U readMsg1();                                                /* read message                 */
public:
	...
	INT8U readMsgBuf0(INT8U *len, INT8U *buf);                       /* read buf                     */
	INT8U readMsgBuf1(INT8U *len, INT8U *buf);                       /* read buf                     */
	
	//static void waitForNewMessage(INT8U len, INT8U *newbuf, INT8U *oldbuf);
